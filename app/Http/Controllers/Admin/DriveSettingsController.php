...
class DriveSettingsController extends Controller
{
    public function index()
    {
        ...
        $files = Files::auth()->get();

        return view('admin.sections.drive-settings', compact('page_title', 'drive_settings', 'files'));
    }
    ...
    public function fileDelete(Request $request)
    {
        ...
        try {
            Files::auth()->where('file_name', $validated['file_name'])->delete();
        } catch (Exception $e) {
            return back()->with('error', 'Something went wrong. Please try again!');
        }
